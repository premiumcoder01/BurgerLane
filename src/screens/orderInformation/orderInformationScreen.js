...
class OrderInformationScreen extends Component {
  componentDidMount() {
  ...
  ratingAndReorderButton() {
    return (
      <View
        ...
        <TouchableOpacity
          activeOpacity={0.9}
          onPress={() => this.props.navigation.push('Rating')}
          style={styles.ratingButtonStyle}>
          <Text style={{ ...Fonts.blackColor16Medium }}>Rating</Text>
        </TouchableOpacity>
        <View style={styles.reviewButtonStyle}>
          <Text style={{ ...Fonts.whiteColor16Medium }}>Re-Order</Text>
        </View>
      </View>
    );
  }
      ...
      <View
        ...
        <View
          ...
          <View style={{ marginLeft: Sizes.fixPadding + 5.0 }}>
            ...
            <Text style={{ ...Fonts.grayColor14Medium }}>Lemon Juice Fresh</Text>
          </View>
        </View>
        <View
          style={{
          ...
          <Text style={{ ...Fonts.blackColor16Medium }}>$2.9</Text>
        </View>
        <View
          style={{
            marginTop: Sizes.fixPadding,
        ...
        <View
          ...
          <Text style={{ ...Fonts.primaryColor20MediumBold }}>$4.2</Text>
        </View>
      </View>
    );
  }
    ...
    return (
      <View
        ...
        <View style={styles.confirmOrderTitleWithIdWrapStyle}>
          <Text style={{ ...Fonts.blackColor22Medium }}>Order Information</Text>
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <Text style={{ ...Fonts.grayColor17Medium }}>ID:</Text>
            <Text style={{ ...Fonts.blackColor17Medium }}>43e2116</Text>
          </View>
        </View>
      </View>
    );
...
OrderInformationScreen.navigationOptions = () => {
  return {
    header: () => null,
  };
};
