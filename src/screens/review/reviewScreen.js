...
const Review = props => {
  ...
  function reviews() {
    return (
      <>
        {props?.restaurantDetails?.review?.map(item => (
          <View key={`${item.id}`}>
      ...
      <View style={styles.ratingInfoWrapStyle}>
        ...
        <View
          ...
          <View
            ...
            <Text style={{left: 5.0, ...Fonts.grayColor16Medium}}>99+</Text>
            <Text style={{...Fonts.grayColor16Medium}}>56</Text>
            <Text style={{...Fonts.grayColor16Medium}}>45</Text>
            <Text style={{...Fonts.grayColor16Medium}}>12</Text>
            <Text style={{left: 5.0, ...Fonts.grayColor16Medium}}>5</Text>
          </View>
    ...
    return (
      <View
        ...
        number == 1.0 ? (
          ...
          <MaterialIcons name="star" size={19} color="#E0E0E0" />
        )}
