  ...
  const renderItem = data => (
    <TouchableHighlight
      ...
      <View style={styles.orderWrapStyle}>
        <Image source={data.item.image} style={styles.restaurantImageStyle} />
        <View
          style={{
          ...
          <Text
            numberOfLines={1}
            style={{maxWidth: width / 1.8, ...Fonts.blackColor16Medium}}>
            {data.item.name}
          </Text>
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            <MaterialIcons name="home" color={Colors.grayColor} size={20} />
            <Text
              numberOfLines={1}
              style={{
                maxWidth: width / 1.8,
          ...
          <View
            ...
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              <MaterialIcons name="star" color={Colors.ratingColor} size={20} />
              <Text
                style={{
                  marginLeft: Sizes.fixPadding - 8.0,
                  ...Fonts.grayColor14Medium,
