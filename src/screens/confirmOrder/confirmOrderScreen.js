  ...
  paymentMethod() {
    const renderItem = ({item}) => (
      <TouchableOpacity
        ...
        />
        <Text
          style={{marginLeft: Sizes.fixPadding, ...Fonts.blackColor19Medium}}>
          {item.number}
        </Text>
        {this.state.currentPaymentIndex == item.id ? (
          <View style={styles.paymentMethodSelectorStyle}>
            <MaterialIcons name="done" size={15} color={Colors.whiteColor} />
          </View>
        ) : null}
      </TouchableOpacity>
    );
      ...
      <View>
        ...
        <View style={styles.addVoucherInfoWrapStyle}>
          <View style={{flex: 1}}>
            ...
            <View
              style={{
                backgroundColor: this.state.voucherFocus
                  ? Colors.primaryColor
                  : Colors.grayColor,
                height: 1.0,
              }}
      ...
      <View
        ...
        <View
          ...
          <Text style={{...Fonts.blackColor16Medium, width: width / 3}}>
            {this.state.cartDetails?.item_detail?.price} *{' '}
            {this.state.cartDetails?.quantity}
          </Text>
          <Text style={{...Fonts.blackColor16Medium, width: width / 2}}>
            $
            {this.state.cartDetails?.item_detail?.price *
      ...
      <View
        ...
        <View style={styles.deliveryToTitleWrapStyle}>
          ...
          <TouchableOpacity
            ...
            <Text style={{...Fonts.blueColor17Medium}}>Add New Address</Text>
          </TouchableOpacity>
        </View>
